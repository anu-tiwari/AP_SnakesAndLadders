...
//        dice_img.setImage(img);
        ...
        initialise_cells();
        initialise_s_l();
        game = new Game(token1, token2, P1_start, P2_start, dice, dice_img, p1_label, p2_label, p1_top, p2_top, p1_bottom, p2_bottom, p1_bg, p2_bg, P1_disname, P2_disname, P1_start, P2_start, arrow);
        x = 0;
        y = 0;
